...
public class UpdateManager {
        ...
        final Handler handler = new Handler() {
            public void handleMessage(Message msg) {
                ...
                if (msg.what == 1) {
                    ...
                    if (mUpdate != null) {
                        if (curVersionCode < mUpdate.getVersionNo()) {
                            apkUrl = mUpdate.getDownloadUrl();
                            updateMsg = mUpdate.getContent();
                            showNoticeDialog();
                        } else if (isShowMsg) {
                    ...
                    UIHelper.ToastMessage(context, msg.obj.toString());
                }
            }
        };
        new Thread() {
            public void run() {
                ...
                BaseResponseBean<Update> responseBean = ApiClient.checkVersion((AppContext) mContext.getApplicationContext());
    ...
    private Runnable mdownApkRunnable = new Runnable() {
        ...
        public void run() {
            try {
                String apkName = "JikeStudent_" + mUpdate.getVersionNo() + ".apk";
                String tmpApk = "JikeStudent_" + mUpdate.getVersionNo() + ".tmp";
                //判断是否挂载了SD卡
