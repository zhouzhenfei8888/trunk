...
public class PreferenceUtils {
    ...
    public static String ACCOUNT_JIKENUM="account_jikenum";
    public static String ACCOUNT_LOGINQQ="account_loginqq";
    public static String ACCOUNT_LOGINPHONE="account_phone";
    public static String ACCOUNT_SEX="account_sex";
    public static String ACCOUNT_LASTLOGINTIME="account_lastlogintime";
