package com.fclassroom.app.widget.TagView;
 ...
 */
public class TagViewEditText extends RelativeLayout{
     ...
     * @param
     */
    public TagViewEditText(Context ctx) {
        super(ctx, null);
     ...
     * @param attrs
     */
    public TagViewEditText(Context ctx, AttributeSet attrs) {
        super(ctx, attrs);
     ...
     * @param defStyle
     */
    public TagViewEditText(Context ctx, AttributeSet attrs, int defStyle) {
        ...
        for (Tag item : mTags) {
            ...
            if (tag.isDeletable) {
                ...
                deletableView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        TagViewEditText.this.remove(position);
