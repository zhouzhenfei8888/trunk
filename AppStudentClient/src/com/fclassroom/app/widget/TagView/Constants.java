...
public class Constants {
	...
	public static final int DEFAULT_TAG_TEXT_COLOR = Color.parseColor("#FF737373");
	public static final int DEFAULT_TAG_DELETE_INDICATOR_COLOR = Color.parseColor("#FF737373");
